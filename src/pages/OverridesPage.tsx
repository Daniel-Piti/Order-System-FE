      ...
      <div className="glass-card rounded-3xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="glass-button px-6 py-3 rounded-xl font-semibold text-gray-800 hover:shadow-lg transition-all flex items-center gap-2"
          >
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="glass-button px-3 py-1.5 rounded-lg text-xs font-semibold text-gray-700 hover:bg-white/40"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => setOverrideToDelete(override)}
                          className="glass-button px-3 py-1.5 rounded-lg text-xs font-semibold text-red-600 hover:bg-red-50/40 border-red-400"
                        >
                          Delete
                        </button>
                      </div>
