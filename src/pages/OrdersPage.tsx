                    ...
                    >
                      {updatingOrderId === order.id ? (
                        ...
                        <>
                          ...
                          <span className="text-xs font-semibold text-green-700">הושלם</span>
                        </>
                      )}
                    </button>
                  </div>
      ...
      {viewingOrder && (
        ...
        >
          ...
          >
            ...
            {/* Link Info */}
            <div className="mb-6">
              <h3 className="text-sm font-semibold text-gray-700 mb-3">מידע קישור</h3>
              <div className="glass-card rounded-xl p-4 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">קישור פג תוקף</span>
