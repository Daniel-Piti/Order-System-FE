        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 justify-items-center">
          {orders && orders.map((order) => {
            ...
            <div key={order.id} className="flex flex-col w-full sm:max-w-[260px] items-center group">
              ...
              <div className="mt-auto pt-3 pb-2 flex flex-col items-center justify-center gap-2 min-h-[40px]">
                ...
                {order.status === 'EMPTY' ? (
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="w-9 h-9 rounded-full border-2 flex items-center justify-center transition-all shadow-sm flex-shrink-0 bg-[#25D366]/10 text-[#25D366] border-[#25D366] hover:shadow-md"
                    ...
                    <button
                      ...
                      className="w-9 h-9 rounded-full border-2 flex items-center justify-center transition-all shadow-sm flex-shrink-0 bg-indigo-50 text-indigo-600 border-indigo-500 hover:shadow-md"
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <button
                      ...
                      className={`w-8 h-8 sm:w-9 sm:h-9 rounded-full border-2 flex items-center justify-center transition-all shadow-sm flex-shrink-0 ${
